...
# 	for unit in data[nation].keys():

# 		if data[nation][unit]["has_ranged_weapon"]:

# 			if data[nation][unit]["unit_type"] == "archer":

# 				data[nation][unit]["ranged_weapon"]["rate_of_fire"] = 6

# 			elif data[nation][unit]["unit_type"] == "crossbow":

# 				data[nation][unit]["ranged_weapon"]["rate_of_fire"] = 3
